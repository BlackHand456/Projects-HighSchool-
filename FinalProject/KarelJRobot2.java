 ...
 */
public class KarelJRobot2 extends Player2
{
    ...
    private Music m;
    /**
     * Constructor for objects of class Liam
     */
    public KarelJRobot2() throws SlickException
    {
    ...
    public void attackp2() throws SlickException
    {
        ...
        {
            evan = new Beeper(x, y, isFacingLeft, 1);
            isAmmo = false;
        }
    }
