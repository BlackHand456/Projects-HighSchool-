 ...
 * @version 2.0
 */
public class Player3 extends Character implements PlayerControls
{
    int tempX;
    int tempY;
    static boolean p2Turn = true;
     ...
     */
    public Player3(int hp, int atk, int def) 
    {
        this.hp = hp;
        this.atk = atk;
        this.def = def;
    ...
    public void fight()
    {
        ...
        if(Greenfoot.isKeyDown("e") && (getX() != tempX || getY() != tempY))
        {
            if(isTouching(EnemyAI.class))
            {
                ...
                GreenfootImage pierce = new GreenfootImage("images\\Pierce.png");
    ...
    public void battleMove()
    {
        if(!isAtEdge())
        {
            if(getY() > tempY - 90)
            {
                ...
                {
                    setImage("images\\Player3Back.png");
                    turnTowards(getX(),0);
                    move(4);
                }
            }
            if(getX() > tempX - 90)
            {
                ...
                {
                    setImage("images\\Player3Left.png");
                    turnTowards(0,getY());
                    move(4);
                }
            }
            if(getX() < tempX + 90)
            {
                ...
                {
                    setImage("images\\Player3Right.png");
            ...
            if(getY() < tempY + 90)
            {
                ...
                {
                    setImage("images\\Player3Front.png");
